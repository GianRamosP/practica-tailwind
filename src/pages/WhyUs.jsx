  ...
  <button className="bg-white hover:bg-gray-100 text-black font-bold py-2 px-4 rounded border border-cyan-500 hover:border-cyan-600">
    <Link to="/signup">Registrarse</Link>
      ...
      <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <img src={camadoble} alt="Habitación en Oferta" class="w-full h-56 object-cover"/>
        <div class="p-4">
          <h3 class="text-lg font-semibold text-gray-700">Habitación Doble - Vista al Mar</h3>
          <p class="text-gray-600">Disfruta de una experiencia inolvidable con vista al océano y todas las comodidades.</p>
          <div class="flex justify-between items-center mt-4">
            <span class="text-xl font-bold text-gray-800">$80/noche</span>
            <button class="px-4 py-2 text-white bg-blue-500 rounded-md focus:outline-none hover:bg-blue-600">Reservar</button>
          </div>
        </div>
      </div>
    ...
    <img src={camadoble} alt="Habitación en Oferta" class="w-full h-56 object-cover"/>
    <div class="p-4">
        <h3 class="text-lg font-semibold text-gray-700">Habitación Individual - Vista a la Ciudad</h3>
        <p class="text-gray-600">Experimenta la comodidad y la energía de la ciudad desde tu habitación privada.</p>
        <div class="flex justify-between items-center mt-4">
...
<div class="bg-white rounded-lg shadow-md overflow-hidden">
    <img src={camadoble} alt="Habitación en Oferta" class="w-full h-56 object-cover"/>
    <div class="p-4">
        <h3 class="text-lg font-semibold text-gray-700">Suite Deluxe - Terraza Privada</h3>
        <p class="text-gray-600">Disfruta de una estancia lujosa con tu propia terraza privada y todas las comodidades exclusivas.</p>
        <div class="flex justify-between items-center mt-4">
...
<div class="bg-white rounded-lg shadow-md overflow-hidden">
    <img src={camadoble} alt="Habitación en Oferta" class="w-full h-56 object-cover"/>
    <div class="p-4">
        <h3 class="text-lg font-semibold text-gray-700">Habitación Familiar - Vistas al Jardín</h3>
        <p class="text-gray-600">Ideal para familias, con hermosas vistas al jardín y espacio para todos.</p>
        <div class="flex justify-between items-center mt-4">
...
<div class="bg-white rounded-lg shadow-md overflow-hidden">
    <img src={camadoble} alt="Habitación en Oferta" class="w-full h-56 object-cover"/>
    <div class="p-4">
        <h3 class="text-lg font-semibold text-gray-700">Suite Ejecutiva - Piscina Privada</h3>
        <p class="text-gray-600">Experimenta el lujo con tu propia piscina privada y servicios ejecutivos de alta calidad.</p>
        <div class="flex justify-between items-center mt-4">
...
<div class="bg-white rounded-lg shadow-md overflow-hidden">
    <img src={camadoble} alt="Habitación en Oferta" class="w-full h-56 object-cover"/>
    <div class="p-4">
        <h3 class="text-lg font-semibold text-gray-700">Habitación Temática - Aventura en la Selva</h3>
        <p class="text-gray-600">Vive una experiencia única con una habitación temática que te transporta a la selva.</p>
        <div class="flex justify-between items-center mt-4">
...
<div class="bg-white rounded-lg shadow-md overflow-hidden">
    <img src={camadoble} alt="Habitación en Oferta" class="w-full h-56 object-cover"/>
    <div class="p-4">
        <h3 class="text-lg font-semibold text-gray-700">Habitación Deluxe - Servicio de Spa Incluido</h3>
        <p class="text-gray-600">Relájate y rejuvenece con nuestro servicio de spa exclusivo incluido en tu estancia.</p>
        <div class="flex justify-between items-center mt-4">
